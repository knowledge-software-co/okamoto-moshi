  ...
  >
    <template #button>
      <svg
        ...
        class="h-5 w-5"
        :class="{
          'text-gray-400 dark:text-gray-500': !hasHiddenColumns,
          'text-green-400 dark:text-green-500': hasHiddenColumns,
        }"
        viewBox="0 0 20 20"
        fill="currentColor"
      >
          ...
          >
            ...
            <button
              ...
              :class="{
                ...
                'bg-gray-200 dark:bg-gray-600': column.hidden,
              }"
            ...
            >
              ...
              <span
                ...
                class="inline-block h-5 w-5 rounded-full bg-white dark:bg-gray-200 shadow-sm transform ring-0 transition ease-in-out duration-200"
              />
            </button>
          </li>
        </ul>
